...
echo -e "${YELLOW}Удаляем BrixAI Relay контейнер...${NC}"
...
if [ "$ARCH" = "amd64" ]; then
    URL="https://raw.githubusercontent.com/admier1/BrinxAI-Relay-Nodes/main/install_brinxai_relay_amd64_deb.sh"
