...
tar -xvf heminetwork_v0.11.5_linux_amd64.tar.gz && rm heminetwork_v0.11.5_linux_amd64.tar.gz
mv -f $HOME/heminetwork_v0.11.5_linux_amd64/* $HOME/heminetwork
rm -rf $HOME/heminetwork_v0.11.5_linux_amd64
