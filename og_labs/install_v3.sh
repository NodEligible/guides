...
echo -e "${BLUE}🔐 Введите ваш приватный ключ кошелька без 0x :${NC}"
read -p "➜ " PRIVATE_KEY
...
sudo apt install nano mc wget build-essential git jq make gcc tmux chrony lz4 unzip ncdu htop -y 
source .profile
source .bashrc
