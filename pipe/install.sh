...
echo "⚠️PIPE устанавливается по индивидуальной ссылке из письма, и при установке невозможно установить последнюю версию и по этому сразу накидаем обнову для корректной роботы ноды‼️"
